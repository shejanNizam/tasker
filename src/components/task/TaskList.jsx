        ...
        <table class="table-fixed overflow-auto xl:w-full">
          <thead>
            <tr>
              ...
              <th class="p-4 pb-8 text-sm font-semibold capitalize w-75">
                {" "}
                Title{" "}
              </th>
              ...
              <th class="p-4 pb-8 text-sm font-semibold capitalize md:w-87.5">
                {" "}
                Tags{" "}
              </th>
              <th class="p-4 pb-8 text-sm font-semibold capitalize md:w-25">
                {" "}
                Priority{" "}
              </th>
              <th class="p-4 pb-8 text-sm font-semibold capitalize md:w-25">
